  ...
  for (p in unique(full_data$parameter)) {
    ...
    if (unique(chart_data$std_order == "asc")){
      chart<-ggplot(data = chart_data) +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = y_min_val, ymax = HIGH, xmin = x_min_val, xmax = x_max_val), fill = '#B7DEE8', alpha = 1)} +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = HIGH, ymax = GOOD, xmin = x_min_val, xmax = x_max_val), fill = '#D8E4BC', alpha = 1)} +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = GOOD, ymax = MODERATE, xmin = x_min_val, xmax = x_max_val), fill = '#FFFF66', alpha = 1)} +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = MODERATE, ymax = POOR, xmin = x_min_val, xmax = x_max_val), fill = '#FFCC66', alpha = 1)} +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = POOR, ymax = y_max_val, xmin = x_min_val, xmax = x_max_val), fill = '#FF9999', alpha = 1)} +
    ...
    if(unique(chart_data$std_order == "desc")){
      chart<-ggplot(data = chart_data) +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = y_min_val, ymax = POOR, xmin = x_min_val, xmax = x_max_val), fill = '#FF9999', alpha = 1)} +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = POOR, ymax = MODERATE, xmin = x_min_val, xmax = x_max_val), fill = '#FFCC66', alpha = 1)} +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = MODERATE, ymax = GOOD, xmin = x_min_val, xmax = x_max_val), fill = '#FFFF66', alpha = 1)} +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = GOOD, ymax = HIGH, xmin = x_min_val, xmax = x_max_val), fill = '#D8E4BC', alpha = 1)} +
        {if(CHART_TYPE == "block")geom_rect(aes(ymin = HIGH, ymax = y_max_val, xmin = x_min_val, xmax = x_max_val), fill = '#B7DEE8', alpha = 1)} +
        {if(CHART_TYPE == "line")geom_rect(data = subset(chart_data, main_trib == "tributary")[1,], aes(fill = main_trib, xmin = x_min_val, xmax = x_max_val, ymin = -Inf, ymax = Inf), fill = "grey", alpha = 0.5)} +
        {if(CHART_TYPE == "line")geom_hline(aes(yintercept = POOR), colour = '#FFCC66', linetype = 2, linewidth = 1.2)} +
        {if(CHART_TYPE == "line")geom_hline(aes(yintercept = MODERATE), colour = '#FFFF66', linetype = 2, linewidth = 1.2)} +
        {if(CHART_TYPE == "line")geom_hline(aes(yintercept = GOOD), colour = '#D8E4BC', linetype = 2, linewidth = 1.2)} +
        {if(CHART_TYPE == "line")geom_hline(aes(yintercept = HIGH), colour = '#B7DEE8', linetype = 2, linewidth = 1.2)} +
    ...
    if(unique(chart_data$std_order == "pH")){
      chart<-ggplot(data = chart_data) +
        {if(CHART_TYPE == "line")geom_rect(data = subset(chart_data, main_trib == "tributary")[1,], aes(fill = main_trib, xmin = x_min_val, xmax = x_max_val, ymin = 0, ymax = 15), fill = "grey", alpha = 0.5)} +
