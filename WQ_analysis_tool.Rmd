...
colnames(summary_tab_data) <- c("Location", "Parameter", "Mean", "SD", "Min", "Max", "Percentile", "Percentile value")
...
#for (l in unique(full_data$location_name)) {
  for (p in unique(full_data$parameter)) {
    ...
    y_min_val <- min(chart_data$y_min)
    y_max_val <- max(chart_data$y_max)
